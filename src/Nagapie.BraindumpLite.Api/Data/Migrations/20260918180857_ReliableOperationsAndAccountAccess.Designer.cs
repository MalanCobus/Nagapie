...
namespace Nagapie.BraindumpLite.Api.Data.Migrations
{
    ...
    [Migration("20260918180857_ReliableOperationsAndAccountAccess")]
    partial class ReliableOperationsAndAccountAccess
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nagapie.BraindumpLite.Api.Data.OperationReceipt", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Nagapie.BraindumpLite.Api.Data.ProcessedDump", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Nagapie.BraindumpLite.Api.Data.RelationalAccount", b =>
                {
                    ...
                    b.Property<int>("SuccessfulAiDumps")
                        .HasColumnType("int");

                    b.HasKey("UserId");

                    b.HasIndex("LicenseHash")
                        .IsUnique()
                        .HasFilter("[LicenseHash] IS NOT NULL");
